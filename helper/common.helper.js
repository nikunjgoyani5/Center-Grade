...
const filteredUser = (user) => {
  const { password, otp, otpExpiresAt, createdAt, updatedAt, expiresIn, otpVerified, isDeleted, isVerified, provider, providerId, role, favoriteCardIds, ...filteredUser } = user.toObject();
  return filteredUser;
};
